#Dijkstra's Algorithm - Implementation (Adjacency List)

# Importing a min-heap module
import heapq
...
class Node:
    ...
    # Function to return whether the actual node's minimum distance is lesser than a given node's minimum distance or not
